...
export default function AddUserForm() {
  ...
  return (
    <form className="grid lg:grid-cols-2 w-4/6 gap-4" onSubmit={handleSubmit}>
      ...
      <button className="flex justify-center text-md w-2/6 bg-green-500 text-white px-4 py-2 border-rounded-md hover:bg-gray-50 hover:borer-green-500 hover:text-green-500 ">
        Add
        <span className="px-1">
          <BiPlus size={24} />
        </span>
